...
return [
    ...
    'providers' => [
        \App\Provider\BalticgruppenProvider::class => [
            ...
            'apiEndpoint' => 'api/odata/tenant/PublishEntries?$expand=LeaseOutCase($expand=Address,MainImage,Details)&$orderby=LeaseOutCase/Address/StreetAddress&$count=true&$filter=(ContractType%20eq%20TenantModels.ContractType%27Residence%27)',
        ],
